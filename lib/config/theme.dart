...
class AppTheme {
  ...
  static ThemeData getThemeData(ThemeMode mode) {
    ...
    return ThemeData(
      ...
      navigationBarTheme: const NavigationBarThemeData(backgroundColor: Colors.red, indicatorColor: Colors.red), dialogTheme: DialogThemeData(backgroundColor: data.colorScheme.surface),
    );
  }
